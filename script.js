...
// Extend the convert function with volume conversions
function convert() {
    const value = parseFloat(inputValue.value);
    const from = inputUnit.value;
    const to = outputUnit.value;
    ...
    // Volume conversions
    else if ((from === 'liters' && to === 'gallons')) output = value * 0.264172;
    else if ((from === 'gallons' && to === 'liters')) output = value / 0.264172;
    else if ((from === 'milliliters' && to === 'fluidOunces')) output = value * 0.033814;
    else if ((from === 'fluidOunces' && to === 'milliliters')) output = value / 0.033814;
